...
export class AnswerInfo {
  constructor() {
    ...
    this.type = 2;//0：操作类或单选，1：多选，2：填空
   ...
   */
  success(id, useranswer='', answer = "",times=1,rightnum = 1,wrongnum = 0) {
    switch (AnswerInfo.type) {
      ...
      //填空
      case 2:
        this._init(id, useranswer, answer,times,rightnum,wrongnum);
        break;
    }
  }
   ...
   * @param wrongnum
   */
  fail(id, useranswer='', answer='', times=1, rightnum = 0, wrongnum = 1) {
    switch (AnswerInfo.type) {
      //单选、操作
      case 0:
